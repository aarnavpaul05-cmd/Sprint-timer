// Sprint Start Reactor — with instant audio/speech unlock for iOS.
...
function unlockAVOnce() {
  ...
  try {
    ...
    // clickless ultra-short beep to satisfy iOS gesture requirement
...
// As a fallback, any tap in the stage will also unlock A/V once.
...
window.addEventListener('beforeinstallprompt', (e) => {
  e.preventDefault(); state.beforeInstallPrompt = e; installBtn.hidden = false;
});
